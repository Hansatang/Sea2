...
//      allStudentsTable.getColumns().add(countryColumn);
   ...
   public void clickItem(MouseEvent event) {
      allStudentsPane.setOnMouseClicked(new EventHandler<MouseEvent>() {

         @Override
         public void handle(MouseEvent event) {
            System.out.println("Clicked on " + (allStudentsTable.getSelectionModel().getSelectedCells().get(0)).getColumn());
         }
      });
   }
